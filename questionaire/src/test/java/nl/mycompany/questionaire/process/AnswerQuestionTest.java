...
public class AnswerQuestionTest {
	...
	@Autowired
	  ...
	  private static final Logger LOG = Logger.getLogger(AnswerQuestionTest.class);
	  ...
	  public void acceptedAuditQuestionTaskTest()
	  {
		  ...
		  ProcessInstance processInstance = service.getProcessInstanceForQuestion(question);
	  ...
	  public void deniedAuditQuestionTaskTest()
	  {
		...
		// Check if a answer question task is available
					Task theAuditTask = taskService.createTaskQuery().processInstanceId(processInstance.getId()).singleResult();
	  ...
	  public void simpleProcessTest() {
	    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("answerQuestionProcess");
